...
aTags.forEach(items => items.style.color = 'green')

const newTag1 = document.createElement('a');
const mainNav = querySelectorAll('nav');
newTag1.innerText = 'Reviews'
newTag1.href = '#'
mainNav.prepend(newTag1)
newTag1.style.color = 'green'

const newTag1 = document.createElement('a');
const mainNav = querySelectorAll('nav');
newTag1.innerText = 'Info'
newTag1.href = '#'
mainNav.prepend(newTag1)
newTag1.style.color = 'green'
...
//footer
let footerInfo = document.querySelectorAll('footer')
footerInfo.innerText = 'Copyright Great Idea! 2018'